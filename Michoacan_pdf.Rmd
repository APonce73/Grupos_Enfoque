...
Mex <- Mex %>% 
  ...
  dplyr::mutate(angle = 90 * sample(c(0, 1), n(), replace = TRUE, prob = c(70, 30))) %>%
...
Los *Grupos de Enfoque* son reuniones entre agricultores, hombres y mujeres por separado, donde se discute y conversa  sobre un tema de interés, en este caso sobre **las plantas útiles para la alimentación** de una localidad o comunidad, basado en cuatro preguntas:  
